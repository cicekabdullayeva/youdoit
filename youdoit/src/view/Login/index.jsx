...
import   * as userAxios from "../../api/Login";
    ...
    render() {
        const customStyles = {
            option: (provided, state) => ({
                ...provided,
                color: '#040647',
                backgroundColor: state.isSelected ? 'rgba(4, 6, 71, 0.1)' : 'transparent',
                padding:'10px',
                margin:'0',
                fontSize : '16px',
                "&:first-of-type" : {
                                ...
                                <Row>
                                    <Col xl={{span: 8, offset:2}} lg={{span: 10, offset:1}}>
                                        ...
                                        <div className="short-desc">
                                            Discover the world’s top <br/> Designers & <br/>Creatives.Discover the <br/> world’s top Designers & <br/> Creatives.
                                        </div>
                                    </Col>
                                </Row>
                            </Col>
                                    ...
                                    <Link to="/">
                                        <div className="back btn-gray flex-vertical-center">
                                            <svg width="8" height="12" viewBox="0 0 8 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M7.41 10.59L2.83 6L7.41 1.41L6 0L0 6L6 12L7.41 10.59Z" fill="rgba(4, 6, 71, .9)"/>
                                            </svg>
                                            Home
                                        </div>
                                    </Link>
                                    ...
                                    <Row>
                                        <Col xl={{span: 8, offset:2}} lg={{span: 10, offset:1}} md={{span: 8, offset:2}} >
                                            ...
                                            <Form className="form-list" onSubmit={this.sendData}>
                                                ...
                                                <div className="or flex-vertical-center">
                                                    Or
                                                </div>
                                                <ul className="socials list-unstyled">
                                                    ...
                                                    <li className="relative">
                                                        <Link to="/" class="btn-effect">
                                                            <span className="flex">Continue with Facebok</span>
                                                        </Link>
                                                    </li>
                                                </ul>
                                            </Form>
                                            <div className="our-customers">
                                                ...
                                                <ul className="list-unstyled flex">
                                                    <li>
                                                        <img src={require('../../assets/img/partner1.svg').default} alt="special"/>
                                                    </li>
                                                    <li>
                                                        <img src={require('../../assets/img/partner2.svg').default} alt="special"/>
                                                    </li>
                                                    <li>
                                                        <img src={require('../../assets/img/partner1.svg').default} alt="special"/>
                                                    </li>
